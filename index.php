                              ...
                              <div class="card-body">
                                ...
                                <div class="d-sm-flex align-items-center mt-1 justify-content-between">
                                  <div class="d-sm-flex align-items-center mt-4 justify-content-between">
                                    <h2 class="me-2 fw-bold">Rs 36,2531.00</h2>
                              ...
                              <div class="card-body">
                                <div class="col-sm-8">
                                  <h3 class="text-white upgrade-info mb-0"> Enhance your <span
                                      class="fw-bold">Ideas</span> for better outreach </h3>
                                      ...
                                      <ul class="todo-list todo-list-rounded">
                                        <li class="d-block">
                                          <div class="form-check w-100">
                                            ...
                                            <div class="d-flex mt-2">
                                              <div class="ps-4 text-small me-3">24 October 2024</div>
                                        ...
                                        <li class="d-block">
                                          <div class="form-check w-100">
                                            ...
                                            <div class="d-flex mt-2">
                                              <div class="ps-4 text-small me-3">23 October 2024</div>
