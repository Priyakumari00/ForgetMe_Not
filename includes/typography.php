          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="includes/buttons.php">Buttons</a></li>
                <li class="nav-item"> <a class="nav-link" href="includes/dropdowns.php">Dropdowns</a></li>
                <li class="nav-item"> <a class="nav-link" href="includes/typography.php">Typography</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
                ...
                <div class="col-md-12 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <p> Lorem Ipsum is simply dummy text of the printing Lorem Ipsum has been the industry's standard
                        dummy text ever since the 1500s, when an unknown printer took a galley not only five centuries,
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <address class="text-primary">
                        ...
                        <p> www.Stores ManagementPro.com </p>
                      </address>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <p> It is a long <span class="fw-bold">established fact</span> that a reader will be distracted by the
                    readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has
                    a more-or-less normal distribution </p>
                </div>
              </div>
            </div>
            <div class="col-md-6 grid-margin stretch-card">
