<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <ul class="nav">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="ui-basic">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="store-list.php">Store List</a></li>
          <li class="nav-item"> <a class="nav-link" href="edit-store.php">Create Store</a></li>
        </ul>
      </div>
    </li>
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="ui-basic">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="category-list.php">Category List</a></li>
          <li class="nav-item"> <a class="nav-link" href="subcategory-list.php">Subcategory List</a></li>
          <li class="nav-item"> <a class="nav-link" href="edit-category.php">Create Category</a></li>
          <li class="nav-item"> <a class="nav-link" href="edit-subcategory.php">Create Subcategory</a></li>
        </ul>
      </div>
    </li>
